...
import dhakre.fr.uha.minimaltodo.payment.ChargeCustomer;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Sumup Sdk implementation
    Button chargeCustomer;
...
//                mAddToDoItemFAB.animate().translationY(0).setInterpolator(new AccelerateInterpolator(2.0f)).start();
        ...
        mRecyclerView.setAdapter(adapter);
//        setUpTransitions();
        chargeCustomer= (Button) findViewById(R.id.button_chargeCustomer);
        chargeCustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,ChargeCustomer.class);
